 ...
 */
class Carton extends \Produit\Carton implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Carton $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getDemoulage()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDemoulage', array());

        return parent::getDemoulage();
    }

    /**
     * {@inheritDoc}
     */
    public function setDemoulage($demoulage)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDemoulage', array($demoulage));

        return parent::setDemoulage($demoulage);
    }
