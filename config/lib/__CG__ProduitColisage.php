 ...
 */
class Colisage extends \Produit\Colisage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'produitId', 'nombreCarton', 'quantiteParCarton', 'codeUsine', 'createdDate', 'updatedDate', 'deletedDate');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Colisage $proxy) {
