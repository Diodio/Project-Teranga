 ...
 */
class LigneColis extends \Empotage\LigneColis implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nombreCarton', 'quantiteParCarton', 'produitId', 'empotage_id', 'createdDate', 'updatedDate', 'deletedDate');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LigneColis $proxy) {
