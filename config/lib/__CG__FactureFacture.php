...
class Facture extends \Facture\Facture implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     */
    public static $lazyPropertiesDefaults = array('dateFacture' => NULL, 'heureFacture' => NULL, 'devise' => NULL, 'portDechargement' => NULL, 'montantHt' => NULL, 'conteneur' => NULL);
    ...
    {
        unset($this->dateFacture, $this->heureFacture, $this->devise, $this->portDechargement, $this->montantHt, $this->conteneur);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'numero', 'dateFacture', 'heureFacture', 'devise', 'portDechargement', 'montantHt', 'montantTtc', 'modePaiement', 'numCheque', 'avance', 'reliquat', 'codeUsine', 'login', 'status', 'regle', 'createdDate', 'updatedDate', 'deletedDate', 'bonsortie', 'conteneur');
        }

        return array('__isInitialized__', 'id', 'numero', 'montantTtc', 'modePaiement', 'numCheque', 'avance', 'reliquat', 'codeUsine', 'login', 'status', 'regle', 'createdDate', 'updatedDate', 'deletedDate', 'bonsortie');
    }
