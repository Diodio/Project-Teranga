...
class BonSortie extends \BonSortie\BonSortie implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     */
    public static $lazyPropertiesDefaults = array('dateBonSortie' => NULL, 'numeroContainer' => NULL, 'numeroPlomb' => NULL, 'numeroCamion' => NULL, 'produit' => NULL);
    ...
    {
        unset($this->dateBonSortie, $this->numeroContainer, $this->numeroPlomb, $this->numeroCamion, $this->produit);
