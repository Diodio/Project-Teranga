...
$sql = "SELECT numero FROM empotage where id=$empotageId";
$Result = mysqli_query($connexion, $sql) or die(mysqli_error($connexion));
$row = mysqli_fetch_array($Result);
    // get the HTML
    ob_start();
    include(dirname(__FILE__).'/empotageContenuPdf.php');
...
//      $html2pdf->pdf->SetProtection(array('print'), 'spipu');
        ...
        $html2pdf->Output('Empotage_'.$row['numero'].'.pdf');
    }
