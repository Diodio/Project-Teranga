    ...
    loadMareyeurs = function () {
        $.post("<?php echo App::getBoPath(); ?>/mareyeur/MareyeurController.php", {userId: "<?php echo $userId; ?>", ACTION: "<?php echo App::ACTION_LIST; ?>"}, function (data) {
            ...
            jQuery(grid_selector).jqGrid({
                ...
                datatype: "local",
                height: 250,
                colNames: [' ', 'Designation', 'Prix Unitaire', 'Quantite', 'Montant'],
                colModel: [
                    ...
                    {name: 'pu', index: 'pu', width: 150, editable: true, editoptions: {size: "20", maxlength: "30"}},
                    {name: 'quantite', index: 'quantite', width: 70, editable: true, editoptions: {size: "20", maxlength: "30"}},
                    {name: 'montant', index: 'montant', width: 90, editable: true, editoptions: {size: "20", maxlength: "30"}},
                ],
                viewrecords: true,
                rowNum: 10,
                rowList: [10, 20, 30],
