    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="col-sm-3">
                ...
                <a href="#modal-table" role="button" class="green" data-toggle="modal"> Liste des mareyeurs </a>
            </h4>
            </div>
            <div class="col-sm-6" style="margin-left: -6%;margin-top: 0.5%;">
                <button id="MNU_MAREYEUR_NEW" class="btn btn-primary btn-xs" title="Mareyeur">
   ...
   //     var grid;
            $.post("<?php echo App::getBoPath(); ?>/mareyeur/MareyeurController.php", {userId: "<?php echo $userId;?>", ACTION: "<?php echo App::ACTION_LIST; ?>"}, function(data) {
                ...
                jQuery(grid_selector).jqGrid({
					...
					datatype: "local",
					height: 250,
					colNames:[' ', 'nom','adresse', 'telephone', 'montantFinancement'],
					colModel:[
