...
<!-- 					     <option value="*" class="types">Filtré par achats</option> -->
                         <option value="0" class="green bigger-130 icon-only">Factures réglées</option>
                         <option value="1" class="orange bigger-130 icon-only">Factures non réglées</option>
               		 </select>
					</div>
        ...
        <i class="fa fa-print bigger-120 white" style="margin-left: 1px;"></i> 
                    ...
                    <div class="widget-body">
                        <div class="widget-main no-padding" style="margin-top:20px">
                          <table id="VENTES_INVENTAIRES" class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
