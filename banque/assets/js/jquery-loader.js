...
(function ($) {
    $.loader_ext = {
        ...
        defaults: {
            ...
            title: '', 
            isOnly: false,
            imgUrl: 'assets/images/loading[size].gif',
            onShow: function () {
            },  
            onClose: function () {
            }  
        ...
        set_define: function () {
            ...
            ops.fontColor && loading.find('span').css('font-size', ops.fontSize);
            ops.fontColor && loading.find('span').css('font-weight', ops.fontWeight);
            ops.fontColor && loading.find('span').css('font-style', ops.fontStyle);
            var self = this;
    ...
    $.loader = {
        tmpl: '<div class="loading_wrp"><div class="loading ${Class}"><img src="assets/images/ajaxloader7.gif"/><span>${Title}</span></div></div>',
