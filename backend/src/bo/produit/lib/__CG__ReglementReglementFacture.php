 ...
 */
class ReglementFacture extends \Reglement\ReglementFacture implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'datePaiement', 'facture', 'avance', 'createdDate', 'updatedDate', 'deletedDate');
        }

        return array('__isInitialized__', 'id', 'facture', 'avance', 'createdDate', 'updatedDate', 'deletedDate');
    }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ReglementFacture $proxy) {
