...
use Produit\FamilleProduit as FamilleProduit;
...
class FamilleProduitController extends BaseController implements BaseAction {
    ...
    public function doList($request) {
        try {
            if (isset($request['userId'])) {
                ...
                $famille = $familleManager->retrieveAll();
                if ($famille != NULL) {
                    $this->doSuccessO($this->listObjectToArray($famille));
                } else
...
$oFamilleProduitController = new FamilleProduitController($_REQUEST);
