 ...
 */
class LigneEmpotage extends \Empotage\LigneEmpotage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nbColis', 'quantite', 'prixUnitaire', 'montant', 'produit_id', 'empotage', 'createdDate', 'updatedDate', 'deletedDate');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LigneEmpotage $proxy) {
