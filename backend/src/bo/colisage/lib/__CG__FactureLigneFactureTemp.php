 ...
 */
class LigneFactureTemp extends \Facture\LigneFactureTemp implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nbColis', 'prixUnitaire', 'quantite', 'montant', 'produit', 'facture', 'createdDate', 'updatedDate', 'deletedDate');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LigneFactureTemp $proxy) {
    ...
    public function getNbColis()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNbColis', array());

        return parent::getNbColis();
    }
    ...
    public function setNbColis($nbColis)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNbColis', array($nbColis));

        return parent::setNbColis($nbColis);
    }
