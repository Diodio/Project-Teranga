 ...
 */
class LigneColisTemp extends \Facture\LigneColisTemp implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nombreCarton', 'quantiteParCarton', 'produitId', 'factureId', 'createdDate', 'updatedDate', 'deletedDate');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LigneColisTemp $proxy) {
