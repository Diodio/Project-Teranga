...
namespace DoctrineORM\Proxies\__CG__\Client;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Client extends \Client\Client implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = array('bonSortie' => NULL);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'reference', 'nom', 'adresse', 'pays', 'telephone', 'bonSortie');
        }

        return array('__isInitialized__', 'id', 'reference', 'nom', 'adresse', 'pays', 'telephone');
    }
