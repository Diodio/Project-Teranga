...
class DemoulageQueries {
    ...
    public function diminueCartonParDemoulageId($produitId, $nombreCarton, $quantiteParCarton) {
        ...
        return $connexion->executeUpdate("UPDATE carton SET nombreCarton = nombreCarton - $nombreCarton WHERE produitId = $produitId AND quantiteParCarton=$quantiteParCarton");
    }
