 ...
 */
class FamilleProduit extends \Produit\FamilleProduit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'libelle', 'createdDate', 'updatedDate', 'deleteDate', 'produit');
        }

        return array('__isInitialized__', 'id', 'libelle', 'produit');
    }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FamilleProduit $proxy) {
