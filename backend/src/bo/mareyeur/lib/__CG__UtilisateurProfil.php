 ...
 */
class Profil extends \Utilisateur\Profil implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'libelle', 'description', 'utilisateur', 'createdDate', 'updatedDate', 'deleteDate');
        }

        return array('__isInitialized__', 'id', 'libelle', 'description', 'utilisateur');
    }
