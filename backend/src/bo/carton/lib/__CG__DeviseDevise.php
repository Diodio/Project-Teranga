...
namespace DoctrineORM\Proxies\__CG__\Devise;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Devise extends \Devise\Devise implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = array('createdDate' => NULL, 'updatedDate' => NULL);
    ...
    {
        unset($this->createdDate, $this->updatedDate);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'devise', 'montant', 'createdDate', 'updatedDate');
        }

        return array('__isInitialized__', 'id', 'devise', 'montant');
    }
