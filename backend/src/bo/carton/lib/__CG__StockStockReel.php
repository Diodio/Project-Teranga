 ...
 */
class StockReel extends \Stock\StockReel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'stock', 'seuil', 'codeUsine', 'login', 'createdDate', 'updatedDate', 'deleteDate', 'produit');
        }

        return array('__isInitialized__', 'id', 'stock', 'seuil', 'codeUsine', 'login', 'produit');
    }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StockReel $proxy) {
