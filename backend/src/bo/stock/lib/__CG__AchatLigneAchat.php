 ...
 */
class LigneAchat extends \Achat\LigneAchat implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'quantite', 'montant', 'poidsTotal', 'montantTotal', 'produit', 'achat', 'createdDate', 'updatedDate', 'deletedDate');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LigneAchat $proxy) {
