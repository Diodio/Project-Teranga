 ...
 */
class LigneBonSortie extends \BonSortie\LigneBonSortie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nombreCarton', 'quantite', 'produit', 'bonSortie', 'createdDate', 'updatedDate', 'deletedDate');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LigneBonSortie $proxy) {
