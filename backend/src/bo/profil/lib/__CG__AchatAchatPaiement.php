 ...
 */
class AchatPaiement extends \Achat\AchatPaiement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'datePaiement', 'mareyeur', 'achat', 'montant', 'createdDate', 'updatedDate', 'deletedDate');
        }

        return array('__isInitialized__', 'id', 'mareyeur', 'achat', 'montant', 'createdDate', 'updatedDate', 'deletedDate');
    }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AchatPaiement $proxy) {
